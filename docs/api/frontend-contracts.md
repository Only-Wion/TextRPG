...
- Provide placeholders for duplicate and archive
...
- Reserve install/export regions for later file-based endpoints
...
- Pack install/export actions remain placeholder UI because file upload and download endpoints are not available yet.
- Duplicate/archive session actions remain placeholder UI because the backend does not yet expose those operations.
